...
exports.put = async (req, res) => {
    try {
        ...
        let { username, email } = (await Database.query(`SELECT username, email FROM user WHERE user_id = '${user_id}'`))[0];
        await Database.insert("verification_code", { user_id, verification_code, change_password: 1 });
